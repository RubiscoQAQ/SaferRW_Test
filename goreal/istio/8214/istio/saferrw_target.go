...
func (s *grpcServer) Report(c xcontext.Context, request *mixerpb.ReportRequest) (*mixerpb.ReportResponse, error) {
	//TODO implement me
	panic("implement me")
}

func (s *grpcServer) Check(c xcontext.Context, request *mixerpb.CheckRequest) (*mixerpb.CheckResponse, error) {
	//TODO implement me
	panic("implement me")
}
...
func main(ctx context.Context, req *mixerpb.CheckRequest) (*mixerpb.CheckResponse, error) {
	s := new(grpcServer)
...
func main1(ctx context.Context, req *mixerpb.ReportRequest) (*mixerpb.ReportResponse, error) {
	s := new(grpcServer)
